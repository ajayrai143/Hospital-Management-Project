				...
				<div class="card paint-card">
					<div class="card-body">
						...
						<form action="../updateDoctor" method="post">
							...
							<div class="mb-3">
								<label class="form-label">DOB</label> <input required="required"
									name="dob" type="date" class="form-control" value="<%=d.getDob() %>">
							</div>
							<div class="mb-3">
							...
							<div class="mb-3">
								<label class="form-label">Specialist</label> <select name="spec"
									type="date" class="form-control" value="<%=d.getSpecialist() %>">
							...
							<div class="mb-3">
								<label class="form-label">Mob No</label> <input
									required="required" name="mobno" type="text"
									class="form-control" value="<%=d.getMobno() %>">
							</div>
							<div class="mb-3">
								<label class="form-label">Password</label> <input
									required="required" name="password" type="text"
